export default function ClaudeRecipe(props) {
  return (
    // <section class="mt-16">
    //   <h2 class="font-bold text-xl mb-6">Chef Claude Recommends:</h2>
    ...
    //       the recipe:
    //     </p>
    //     <h3 class="mt-4 mb-4 font-bold text-lg">Beef Bolognese Pasta</h3>
    //     <strong>Ingredients:</strong>
    //     <ul class="list-disc leading-8 text-stone-500">
    ...
    //     <ol class="text-stone-500 leading-8 list-decimal">
